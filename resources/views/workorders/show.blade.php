                    ...
                    <div class="card-action">
                        <div class="row" style="margin-bottom: 0;">
                            <div class="col s6 center white-text">
                                <i class="material-icons left">calendar_today</i><strong>Start datum & tijd:
                                </strong>{{ $workorder->start }}
                            </div>
                            <div class="col s6 center white-text">
                                <i class="material-icons left">calendar_today</i><strong>Eind datum & tijd:
                                </strong>{{ $workorder->end }}
                            </div>
                        </div>
                    </div>
                </div>
                                ...
                                <div class="col s12 m6 l4">
                                    <div class="card">
                                        <div class="card-image">
                                            <img src="{{ Str::startsWith($photo->url, ['http://', 'https://']) 
                                                ? $photo->url 
